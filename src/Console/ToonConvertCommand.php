...
class ToonConvertCommand extends Command
{
    protected $signature = 'toon:convert
                            ...
                            {--d|--decode : Decode TOON to JSON (default when --decode set)}
    ...
    public function handle(Filesystem $fs): int
    {
        ...
        $decode = $this->option('decode') || !$this->option('encode');
        ...
        try {
            if ($file) {
                ...
                $this->info('Reading from STDIN (press Ctrl+D to end input):');
